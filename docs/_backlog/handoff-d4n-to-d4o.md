...
- DB 스키마 정의 (테이블 5종): users, projects, locations, vendors, photos
...
- **Phase 5.2 의 thin slice**: 5종 테이블 한 번에 vs 단계별 분할 (예: users + projects 먼저, locations + vendors + photos 후속) 결정 필요
